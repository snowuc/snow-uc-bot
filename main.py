...
def callback_query(call):
    ...
    if call.data == "buy_menu":
        ...
        packs = [
            ("60 UC", "buy_60"), ("120 UC", "buy_120"), ("180 UC", "buy_180"), ("325 UC", "buy_325"), 
        ...
        bot.edit_message_text("Введите ваш игровой ID (начинается на 5):", chat_id, call.message.message_id)
